...
public class TestConsumerHelper {
  ...
  static final NewTopic IN = new NewTopic(Constants.INPUT_TOPIC_CONFIG_DEFAULT, 1, (short) 1);
  static final NewTopic OUT = new NewTopic(Constants.OUTPUT_TOPIC_CONFIG_DEFAULT, 1, (short) 1);
